      ...
      {isLoading || !movie ? (
        ...
        <>
          <div className='flex flex-col gap-6 items-center justify-center'> 
            ...
            <p>
              <span>IMBD :</span>
              <span className='text-yellow-400 ms-2 font-semibold text-lg'>{movie.vote_average.toFixed(1)}
              </span>
            </p>
            <div className='flex gap-5'>
              <Link 
              to={`/movie/${movie.id}`} 
              className='p-2 bg-red-600 rounded hover:bg-red-700'>Filmi İzle
              </Link>
          ...
          <div className='banner flex justify-center '>
            ...
            <img className='my-4 object-contain rounded max-h-[300px]' src={baseImgUrl + movie.
backdrop_path} alt="" />
          </div>
